        ...
        <div className="bg-white lg:px-20">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>3845 Reviews</p>
                            </div>
                            </div>
                            ...
                            <form className="mt-10">
                                ...
                                <Button onClick={handleAddToCart} className='' variant='contained' sx={{px:"2rem", py:"1rem", bgcolor:"#9155fd " ,}}>
                                   Add  To Cart 
                                </Button>
                            </form>
                        </div>
           ...
           <Grid item sx={5}>
            ...
            <div className='flex items-center space-x-3'>
                ...
                <p className='opacity-60'>58387 Ratings</p>
            </div>
