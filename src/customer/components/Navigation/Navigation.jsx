...
export default function Navigation() {
  ...
  const handleOpen = () =>{
    setOpenAuthModal(true); ///modal issue maybe
  };
  const handleClose =() =>{
            ...
            <div className="flex h-16 items-center px-11">
              ...
              <div className="ml-4 flex lg:ml-0">
                  ...
                  <img
                    ...
                    src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600"//logo accordingly
                    alt="OnileLogo"
                  />
